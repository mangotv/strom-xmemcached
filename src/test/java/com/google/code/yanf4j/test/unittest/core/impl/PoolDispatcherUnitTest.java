...
public class PoolDispatcherUnitTest {
    ...
    @Before
    public void setUp() {
        this.dispatcher = new PoolDispatcher(10, 60, TimeUnit.SECONDS, new SThreadPoolExecutor.AbortPolicy(), "test");
    }
    ...
    public void testDispatchReject() throws Exception {
        ...
        this.dispatcher = new PoolDispatcher(1, 60, TimeUnit.SECONDS, new SThreadPoolExecutor.AbortPolicy(), "test");
