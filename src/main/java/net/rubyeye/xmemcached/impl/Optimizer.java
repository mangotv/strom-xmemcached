 ...
 * @author dennis
 */
public class Optimizer implements OptimizerMBean, MemcachedOptimizer, Serializable {

    public static final int DEFAULT_MERGE_FACTOR = 50;
    public static int mergeFactor = DEFAULT_MERGE_FACTOR; // default merge factor;
    ...
    private final ThreadLocalListCommand threadLocal = new ThreadLocalListCommand();
    ...
    private static final ThreadLocalBinarySetQCollector BIN_SET_CMD_COLLECTOR_THREAD_LOCAL = new ThreadLocalBinarySetQCollector();
    ...
    private static ThreadLocalKeyStringCollector TEXT_GET_CMD_COLLECTOR_THREAD_LOCAL = new ThreadLocalKeyStringCollector();

    private static ThreadLocalBinaryGetQCollector BIN_GET_CMD_COLLECTOR_THREAD_LOCAL = new ThreadLocalBinaryGetQCollector();
