...
import system.SThreadFactory;
import system.SThreadPoolExecutor;
 ...
 * @author dennis
 */
public class MemcachedHandler extends HandlerAdapter implements Serializable {
    ...
    public void start() {
        ...
        this.heartBeatThreadPool = new SThreadPoolExecutor(1, MAX_HEARTBEAT_THREADS,
                keepAliveTime, TimeUnit.MILLISECONDS,
                new SynchronousQueue<Runnable>(),
                new SThreadFactory(threadCounter,name), new SThreadPoolExecutor.DiscardPolicy());
    }
